...
h = xlabel('Significand precision', 'FontName', font);
set(h,'FontSize',20);
...
g = ylabel('Sum of relative errors (compared to optimal Lorenz Attractor run (prec=200))', 'FontSize', 20);
% set(g,'FontSize',30);
